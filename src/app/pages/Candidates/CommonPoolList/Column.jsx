...
import {
  ...
  SelectMore2,
  SelectMore3,
} from '../newList/search/components/candidateSearchSelects';
import {
  Inputdiys,
  Inputdiy,
  InputCurrent,
  ...
  SaveFilter,
  CompanyInput,
} from '../newList/search/components/candidateSearchInputs';
import { commonPoolColumns } from '../../../../utils/search';
// import { commonPoolColumns } from '../../../../utils/newCandidate';
import CandidateTree from '../newList/search/components/candidateTreeSelects';
import CandidateWorkAuth from '../newList/search/components/candidateWorkAuths';
import CandidateJobFunction from '../newList/search/components/candidateJobFunctions';
...
const Column = ({ onSave, onDelete, data, index, last, onCopy, keys }) => {
  ...
  useEffect(() => {
    let arr = [];
    let newColumns = lodash.cloneDeep(commonPoolColumns);
  ...
  // Advanced Search中ColumnName列的select的change事件
  ...
  const checkType = (data, index, item) => {
    ...
    let type = null,
      colName = null;
    commonPoolColumns.forEach((item) => {
      if (item.field == data) {
        type = item['type'];
      }
    });
