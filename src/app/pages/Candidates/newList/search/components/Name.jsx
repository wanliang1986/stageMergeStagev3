...
import { isEn, isPhone, isSymbol } from '../../../../../../utils/search';
import Autocomplete, {
  createFilterOptions,
...
class Name extends React.Component {
  ...
  fetchLocationList = (e) => {
    ...
    // 高级搜索和基础搜索判断
    if (this.props.data.col == 'email') {
      query = isEn(e.target.value);
    }
    if (this.props.data == 'email') {
      query = isEn(e.target.value);
    }
    if (this.props.data.col == 'phone') {
      query = isPhone(e.target.value);
    }
    if (this.props.data == 'phone') {
      query = isPhone(e.target.value);
    }
    if (this.props.data == 'name') {
      query = isSymbol(e.target.value);
    }
    if (this.props.data.col == 'name') {
      query = isSymbol(e.target.value);
    }
    ...
    return (
      <div className={classes.root}>
        <FormInput
          ...
          className={errorMessage ? classes.msg : ''}
          isRequired={false}
