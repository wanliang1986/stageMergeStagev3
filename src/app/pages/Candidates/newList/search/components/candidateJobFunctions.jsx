...
const CandidateJobFunction = ({
  ...
  const { jobFounctionList } = candidateSelect.toJS();
...
export default connect(mapStateToProps)(
  withStyles(styles)(CandidateJobFunction)
);
