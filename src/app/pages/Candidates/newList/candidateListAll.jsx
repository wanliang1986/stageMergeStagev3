...
import AllTable from './table/index';
...
class CandidateListAll extends React.PureComponent {
  ...
  componentWillUnmount() {
    this.props.dispatch(candidateCurrentPageModel('candidateAll'));
  }
...
function mapStoreStateToProps(state) {
  ...
  const { resume, basicSearch, advancedFilter, general, pageModel } =
