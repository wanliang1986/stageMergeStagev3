  ...
  renderCommission = (commission, userRole, ownerSize) => {
    ...
    return (
      <div key={index} className="row expanded">
        <div className="small-4 columns">
          <FormReactSelectContainer>
            <Select
              ...
              autoBlur
              clearable={false}
              onChange={(newUserRole) => {
                if (newUserRole) {
                  commission.userRole = newUserRole;
                  this.setState({ startCommissions: startCommissions.slice() });
                }
              }}
              disabled={
                !edit || positionType === JOB_TYPES.Payrolling || disableEdit
              }
            />
          </FormReactSelectContainer>
        </div>
        ...
        {positionType === JOB_TYPES.Payrolling || !edit ? (
          <div className="small-4 columns">
            <FormInput
          ...
          <>
            ...
            <div className="small-2 columns horizontal-layout align-self-top">
              <IconButton
                size="small"
                disabled={
                  startCommissions.length <= 1 + ownerSize || disableEdit
                }
                onClick={() => {
                  this.setState({
