...
class Contract extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startDate: moment
        .max([
          moment(),
          moment(props.startContractRate.startDate).add(1, 'days'),
        ])
        .format('YYYY-MM-DD'),
  ...
  handleSubmit = (e) => {
    ...
    dispatch(
      addStartContractRate(newStartContractRate, oldStartContractRate.startId)
    )
      .then((startContractRates) => {
        ...
        return Immutable.fromJS(startContractRates).last().get('id');
      })
  ...
  render() {
    ...
    const { t, startContractRate } = this.props;
    if (loadingParams) {
      return null;
    }
    return (
      <>
        <DialogTitle>{t('common:Add Rate Change')}</DialogTitle>
        <DialogContent>
            ...
            <div className="row expanded">
              <div className="small-6 columns">
                <DatePicker
                  ...
                  minDate={moment(startContractRate.startDate).add(1, 'days')}
                ...
                <input
                  name="oldStartDate"
                  type="hidden"
                  value={startContractRate.startDate || ''}
                />
              </div>
