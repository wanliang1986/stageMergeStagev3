...
import MyTree from '../Companies/Form/PotentialServiceTypeSelect/PotentialServiceTypeSelect';
...
class JobBasicForm extends React.PureComponent {
  ...
  _getStateFromProps = (props, state = {}) => {
    ...
    return {
      ...
      billRateUnitType:
        state.billRateUnitType || props.job.get('payType') || 'YEARLY',
      payRateUnitType:
  ...
  fetchJobList = () => {
    apnSDK.getJobFunction().then((res) => {
      ...
      this.setState({ jobList: res.response, jobCheckedList: arr ? arr : [] });
    });
  };
  fetchDegreeList = () => {
