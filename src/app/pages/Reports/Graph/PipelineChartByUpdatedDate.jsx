...
import {
  ...
  getNewPipelineReportByUpdatedDate,
} from '../../../../apn-sdk';
...
class ChartWithTable extends React.Component {
  ...
  fetchData = (
    ...
    this.task = makeCancelable(
      getNewPipelineReportByUpdatedDate({ fromDate, toDate, userParams })
    );
    this.task.promise
      .then(({ response }) => {
  ...
  downloadCanvas = (e, filename = 'Pipeline Analytics by Updated Date.png') => {
    ...
    return (
      ...
      >
        <div>
          ...
          >
            <div>
              <FormReactSelectContainer label={t('field:Updated Date')}>
                <DateRangePicker
                  value={range}
                  ranges={getRanges(t)}
                  cleanable={false}
