...
import { styles, jobPipielineByCompanyColumns as columns } from '../params';
...
class Reports extends React.PureComponent {
  ...
  fetchData = (blockTimerPromise = Promise.resolve()) => {
    ...
    this.task.promise
      .then((data) => {
        ...
        const footerData = data.find((el) => el.company === 'Grand Total');
  ...
  handleTypeChange = (event) => {
    this.setState({ allOpenJobs: event.target.checked }, () => {
      this.fetchData(this._blockTimer());
    });
  };
