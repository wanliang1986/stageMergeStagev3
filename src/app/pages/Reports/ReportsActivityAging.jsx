...
import { getPipelineReportByDetailsExcel, getPipelineReportByDetails } from '../../../apn-sdk/index';
...
class ReportsActivityAging extends React.PureComponent {
    ...
    downloadReportData = () => {
        ...
        const { activityId } = this.props;
        getPipelineReportByDetailsExcel({ activity_id: activityId })
            .finally(() => {
        ...
        return (
            ...
            >
                <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ padding: 5 }}>
                        <PotentialButton onClick={this.downloadReportData} processing={this.state.generating}>
                            {t('common:download')}
                        </PotentialButton>
                    </div>
