...
class SaveDocumentDialog extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log('nextProps', nextProps.saveFiltersObj);
    this.setState({
      open: nextProps.open,
    });
  }
  ...
  handleDelete = (e, item, index) => {
    ...
    //   arr: arrList,
    // });
    // deleteFilterCandidate(item.id).then((res) => {
    //   console.log('res', res);
    // });
  ...
  handleChange = (e) => {
    ...
    getFilterSearchDocument(value).then((res) => {
      console.log('res', res);
...
const mapStateToProps = (state) => {
  let saveFiltersObj =
    state.controller.documentView.toJS().saveFiltersObj || [];
  return {
    saveFiltersObj,
