...
export const RECEIVE_APPLICATION_COMMISSIONS =
  'RECEIVE_APPLICATION_COMMISSIONS';
...
export const GET_HOT_LIST_TALENTS = 'GET_HOT_LIST_TALENTS';
export const GET_HOT_LIST_TALENTS2 = 'GET_HOT_LIST_TALENTS2';
export const ADD_HOT_LIST_TALENT = 'ADD_HOT_LIST_TALENT';
...
export const GET_ALL_INVOICE_LIST = 'GET_ALL_INVOICE_LIST';
export const CLEAR_INVOICE_LIST = 'CLEAR_INVOICE_LIST';

export const GET_INVOICE_DETAIL_LIST = 'GET_INVOICE_DETAIL_LIST';
export const CLEAR_INVOICE_DETAIL_LIST = 'CLEAR_INVOICE_DETAIL_LIST';
export const EDIT_INVOICE_DETAIL_STATUS = 'EDIT_INVOICE_DETAIL_STATUS';
...
export const CLRAE_START = 'CLRAE_START';
...
export const UPDATE_FILTERS2 = 'update_filters2';
...
// 流程面试次数第几次
export const EDIT_INTERVIEW_INDEX = 'EDIT_INTERVIEW_INDEX';
// 提交至job获取页面配置信息
export const APPLICATION_POSITION_SECTION = 'APPLICATION_POSITION_SECTION';
// 获取 recruitmentProcessId
export const APPLICATION_RECRUITMENTID_GET = 'APPLICATION_RECRUITMENTID_GET';
export const APPLICATION_EDITFLAG = 'APPLICATION_EDITFLAG';
