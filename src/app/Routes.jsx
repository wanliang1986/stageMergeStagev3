...
const AsyncDoocument = lazy(() => import('./pages/Dashboard/Doocument'));
const AsyncSetting = lazy(() => import('./pages/Setting'));
// const AsyncTimesheets = lazy(() => import('./pages/timesheets'));
    ...
    <div className={classes.container}>
      <Suspense fallback={<Loading />}>
        <Switch>
          ...
          <PrivateRoute path="/document" component={AsyncDoocument} />
          <PrivateRoute path="/setting" component={AsyncSetting} />
