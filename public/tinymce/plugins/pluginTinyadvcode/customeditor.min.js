...
!function() {
  ...
  function s(e) {
    return A(e) ? e : j.fromDom(a(e).dom.body)
  }
  function d(e, t, n) {
    if (!_(n))
    ...
    var r;
    void 0 !== (r = e).style && E(r.style.getPropertyValue) && e.style.setProperty(t, n)
  }
  var m, p, h, v, y, g = function(n) {
    function e() {
      return o
    }
    function t(e) {
    ...
    return function(e) {
      ...
      function(e) {
        return e = typeof (t = e),
        (null === t ? "null" : "object" == e && (Array.prototype.isPrototypeOf(t) || t.constructor && "Array" === t.constructor.name) ? "array" : "object" == e && (String.prototype.isPrototypeOf(t) || t.constructor && "String" === t.constructor.name) ? "string" : e) === m;
        var t
      }
  ), b = T("boolean"), E = T("function"), I = T("number"), e = ("undefined" != typeof window || Function("return this;")(),
      function(t) {
        return function(e) {
          return e.dom.nodeType === t
        }
      }
  ), L = e(1), x = e(9), A = e(11), O = function(e) {
    if (null == e)
    ...
    fromPoint: function(e, t, n) {
      return w(e.dom.elementFromPoint(t, n)).map(O)
    }
  }, N = E(Element.prototype.attachShadow) && E(Node.prototype.getRootNode) ? function(e) {
  ...
  h = T,
    ...
    y = p = void 0,
    function(e) {
      "object" == typeof h && void 0 !== v ? v.exports = e() : "function" == typeof p && p.amd ? p([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = e()
    }(function() {
      return function r(o, i, u) {
        ...
        for (var f = "function" == typeof y && y, e = 0; e < u.length; e++)
          c(u[e]);
        return c
      }({
        1: [function(e, t, n) {
  ...
  function P(t) {
    return w(tinymce.get).bind(function(e) {
      return w(e(t))
    })
  }
  function R(e, t, n, r) {
    ...
    void 0 === r && (r = "");
    var i = C(e, P(n.editorId).map(function(e) {
      e = N(j.fromDom(e.getElement()));
      return s(e).dom
    }).getOrUndefined())
      , r = {
  ...
  function k(t, n) {
    if (U[n])
      return F.resolve();
    var r, o, e = P(n), i = e.bind(function(e) {
      return w(null === (e = e.ui) || void 0 === e ? void 0 : e.styleSheetLoader)
  ...
  function D(e, t, n) {
    return F.all([k(t, n), (n = "tinymce.plugins.advcode.CodeMirror",
      e = e,
    tinymce.Resource || S(),
  ...
  function M(r, o) {
    return new F(function(e) {
        ...
        !function(e, t, n) {
          ...
          w(t.dom.parentNode).map(j.fromDom).filter(L).each(function(e) {
            return t = "mce-codemirror",
              void (void 0 !== (e = e).dom.classList ? e.dom.classList.add(t) : l(e, t));
            var t
          }),
          e(D(o.codeMirrorScriptUrl, o.codeMirrorCssUrl, o.editorId).then(function(e) {
            var e = R(e, r, o)
              , t = e.cmi
              , n = e.unbind;
            return {
  ...
  var U = {};
  tinymce.Resource.add("tinymce.plugins.advcode.customeditor", M)
}();
