...
!(function () {
  ...
  function i(e, t) {
    ...
    return 0 !== n || 0 !== (n = r(e.minor, t.minor))
      ? n
      : 0 !== (t = r(e.patch, t.patch))
      ? t
      : 0;
  }
  ...
  function g(e) {
    return N(e) ? e : ((e = e), j.fromDom(e.dom.ownerDocument));
  }
  ...
  var b,
    ...
    D = d(11),
    R =
      k(Element.prototype.attachShadow) && k(Node.prototype.getRootNode)
        ? function (e) {
              ...
              (t.nextTick = function (e) {
                ...
                if (1 < arguments.length)
                  for (var n = 1; n < arguments.length; n++)
                    t[n - 1] = arguments[n];
                f.push(new p(e, t)), 1 !== f.length || l || c(m);
              }),
  ...
  function F() {
    ...
    tinymce.Resource = {
      add: function (e, t) {
        a[e] && (a[e](t), delete a[e]), (n[e] = V.resolve(t));
      },
      load: function (r, o) {
          ...
          return (
            !!(
              ...
              (/['"]/.test(e.string.charAt(e.string.length - 1)) &&
                1 !== e.string.length)
            ) && n.innerMode(t.getMode(), e.state).state.tagName
          );
        });
      },
    };
  ...
  function q(e, t, n, r) {
    ...
    return (
      ...
      setTimeout(
        function () {
          u.focus(), n.cursor && u.doc.setCursor(n.cursor);
        },
        tinymce.Env.ie ? 50 : 0
      ),
      setTimeout(function () {
  ...
  function W(t, n) {
    ...
    var r,
      ...
      i = e
        .bind(function (e) {
          return x.from(
            null === (e = e.ui) || void 0 === e ? void 0 : e.styleSheetLoader
          );
        })
    ...
    return (
      e.each(function (e) {
        e.on('remove', function () {
          i.unload && i.unload(t), delete J[n];
        });
      }),
      (J[n] = !0),
      (r = t),
  ...
  function G(e, t, n) {
    return V.all([
      W(t, n),
      ((n = 'tinymce.plugins.advcode.CodeMirror'),
      (e = e),
      tinymce.Resource || F(),
      tinymce.Resource.load(n, e)),
    ]).then(function (e) {
      e[0];
      return (0, e[1])();
    });
        ...
        onPostRender: function () {
          ...
          (t = n.getEl('body')),
            ...
            o.onPostRender(r).then(function () {
              e.hide(), n.statusbar.items().disabled(!1);
            });
        },
        onSubmit: function (e) {
          o.onSubmit(e.data);
  ...
  function re(t, e) {
    var n = t.dom,
      ...
      o = r.getBookmark(),
      n = ee(o)
        ? n.select(o.name)[o.index]
        : n.select('#' + o.id + '_start')[0],
      ...
      e = e();
    return n.each($), r.moveToBookmark(o), e;
  }
  ...
  function ie(o, i) {
    var e,
      t,
      n,
      u = G(i.codeMirrorScriptUrl, i.codeMirrorCssUrl, i.editorId),
      c =
        ((e = x.none()),
        (t = e),
        (n = {
    ...
    Q(o, {
      ...
      onSubmit: function () {
        return c.on(function (e) {
          K(o, e.cmi.doc.getValue()), e.unbind();
        });
      },
      onClose: function () {
        return c.on(function (e) {
  ...
  function ae(r, o) {
    return new V(function (e) {
      ...
      !(function (e, t, n) {
        ...
        e(
          G(o.codeMirrorScriptUrl, o.codeMirrorCssUrl, o.editorId).then(
            function (e) {
              var e = q(e, r, o),
                t = e.cmi,
                n = e.unbind;
  ...
  function fe(t) {
    ...
    if (((n = tinymce), (r = '5.0.12'), !n || 1 !== i(u(n), o(r))))
      return L(L({}, e), {
        init: function (e) {
          return ae(e, t);
        },
  ...
  function le(t, e) {
    var n = oe(t),
      ...
      n = {
        ...
        onSubmit: function (e) {
          K(t, e.getData().codeview), e.close();
        },
      };
